...
column_constraint_body
    ...
    | (FOREIGN KEY)? REFERENCES qualified_name (LR_BRACKET id RR_BRACKET)? opt_on_delete_or_udpate not_for_replication?
    ;
...
table_constraint_body
    ...
    | FOREIGN KEY LR_BRACKET fk = column_name_list RR_BRACKET REFERENCES qualified_name (LR_BRACKET pk = column_name_list RR_BRACKET)? opt_on_delete_or_udpate not_for_replication?
    ;

opt_on_delete_or_udpate
    : /* EMPTY */ 
    | on_delete
    | on_update
    | on_delete on_update
